...
const AddFlight = () => {
    ...
    const handleSearch = async (e) => {
        e.preventDefault();
        try {
            const response = await Axios.post("http://localhost:3001/SearchFlightShow", {
                origin: searchCriteria.origin,
                destination:searchCriteria.des
            });
                            ...
                            <table cellPadding="8" style={{ inlinecss2 }}>
                                <tbody style={{ margin: '20px', color: 'white' }}>
                                    <tr>
                                        <td>Origin:</td>
                                        <td>
                                            <label className="tbtd">You can search using Origin & Destination & AirplaneID &Airline</label>
                                            <input
                                                type="text"
                                                placeholder="ENTER AIRLINE/ORIGIN_CITY"
                                                className="Aa"
                                                name="origin"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                type="text"
                                                placeholder="ENTER DESTINATION_CITY"
                                                className="Aa"
                                                name="des"
                                                value={searchCriteria.des}
                                                onChange={handleChange}
                                            />
                                        </td>
                                    </tr>
