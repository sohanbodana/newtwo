...
import fl from '../Navbar/airplane.png';
import "../footer.css";
                    ...
                    <div className="footer-content">
                        <div className="footer-content-column">
                            <Link className="navbar-brand" to={`${process.env.PUBLIC_URL}/`} style={{ marginLeft: '10px' }}>
                                <img src={fl} className='fl21' alt='img'/>
                            </Link>
                            ...
                            <div className="footer-menu">
                                ...
                                <ul id="menu-legal" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-170434">
                                        <a href="/contact-us">Privacy Notice</a>
                                    </li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page">
                            ...
                            <div className="footer-menu">
                                ...
                                <ul id="menu-quick-links" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-custom menu-item-object-custom">
                                        <a  rel="noopener noreferrer" href="/contact-us" >Support Center</a>
                                    </li>
                                
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page">
                                        <a href="/contact-us">Security</a>
                                    </li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page">
                                        <a href="/contact-us">Blog</a>
                                    </li>
                                    <li className="menu-item menu-item-type-post_type_archive menu-item-object-customer">
                                        <a href="/contact-us">Customers</a></li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page">
                                        <a href="/contact-us">Reviews</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div className="footer-content-column">
                            <div className="footer-call-to-action">
                                ...
                                <a className="footer-call-to-action-button button" href="/contact-us" target="_self"> Get in Touch </a>
                            </div>
                            <div className="footer-call-to-action">
                                <h2 className="footer-call-to-action-title"> You Call Us</h2>
                                <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="/contact-usel:0124-64XXXX" target="_self"> 0124-64XXXX </a></p>
                            </div>
                        <span className='navb2'>AIR-EASY</span>
                        </div>
                        {/* <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
                            ...
                            <a className="footer-social-link linkedin" href="/contact-us" >
                            ...
                            <a className="footer-social-link twitter" href="/contact-us" >
                            ...
                            <a className="footer-social-link youtube" href="/contact-us" >
                            ...
                            <a className="footer-social-link github" href="/contact-us" >
                    ...
                    <div className="footer-copyright">
                        <div className="footer-copyright-wrapper">
                            <p className="footer-copyright-text">
                                <a className="footer-copyright-link" href="/contact-us" target="_self"> ©2024. | Designed By: Sohan Bodana. | All rights reserved. </a>
                            </p>
                        </div>
                    </div>
                </footer>
