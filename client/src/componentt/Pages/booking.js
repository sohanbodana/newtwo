...
const Booking = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            navigate('/confirmation', { state: { selectedFlight, formData, selectedDate,userdata } });
    ...
    const savebutton = async (e) => {                 ///////////////////////////  save multiple users data????????????????????????????????????
        e.preventDefault();
        try {
            ...
            <body style={{ marginTop: "50px" }}>
                <form onSubmit={handleSubmit}>
                    <div>
                        <center>
                        <tbody>
                           <table cellPadding="12">   {/*  /// space between column & row */}
                                     <tr>
                                        <td>
